...
def svm_train():
    ...
    df0 = pd.read_csv("./data/data_state1_cvt.txt", header=None, names=column_names)
    df0["state"] = 1
    df1 = pd.read_csv("./data/data_state2_cvt.txt", header=None, names=column_names)
    df1["state"] = 0
    ...
    plt.savefig("./output/pca_scree_plot.png")
